...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "tth_grok.settings")

from tth_grok.telemetry import configure_opentelemetry, instrument_django  # noqa: E402
...
from tth_grok.sessions import get_session_store  # noqa: E402
from tth_grok.shared.private_env import seal  # noqa: E402
