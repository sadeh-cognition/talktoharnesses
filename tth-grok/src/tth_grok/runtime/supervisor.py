...
from tth_grok.shared.paths import resolve_launch_paths
from tth_grok.shared.policy import RuntimePolicy
from tth_grok.shared.redaction import StreamingTextRedactor
...
class ProcessSupervisor:
    ...
    async def spawn(
        ...
        *,
        ...
        from tth_grok.shared.paths import resolve_directory, resolve_executable
    ...
    async def _cleanup_late_creation(
        ...
        if job is not None and sys.platform == "win32":
            from tth_grok.runtime.windows_job import close_job, terminate_job
    ...
    async def _create_process_windows(
        ...
        from tth_grok.runtime.windows_job import (
