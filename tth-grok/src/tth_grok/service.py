"""Create-session and probe orchestration for the Grok split.
...
from tth_grok.harness.compatibility import load_grok_compatibility
...
from tth_grok.sessions import SessionEntry, get_session_store
from tth_grok.shared.compatibility import (
    comparable_probe_version,
    compare_dotted,
    version_advisory,
)
from tth_grok.shared.paths import resolve_directory, resolve_kind_executable
