...
# method. The ``tth_muse`` logger only sets a level and propagates to the root
...
LOGGING = {
    ...
    "formatters": {
        "split": {
            "()": "tth_muse.shared.logs.UtcFormatter",
    ...
    "loggers": {"tth_muse": {"level": _LOG_LEVEL}},
}
