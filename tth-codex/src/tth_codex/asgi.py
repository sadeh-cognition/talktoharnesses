...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "tth_codex.settings")

from tth_codex.telemetry import configure_opentelemetry, instrument_django  # noqa: E402
...
from tth_codex.sessions import get_session_store  # noqa: E402
from tth_codex.shared.private_env import seal  # noqa: E402
