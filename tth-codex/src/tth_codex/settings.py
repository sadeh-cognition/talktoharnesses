...
# method. The ``tth_codex`` logger only sets a level and propagates to the root
...
LOGGING = {
    ...
    "formatters": {
        "split": {
            "()": "tth_codex.shared.logs.UtcFormatter",
    ...
    "loggers": {"tth_codex": {"level": _LOG_LEVEL}},
}
