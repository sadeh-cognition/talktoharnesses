...
# method. The ``tth_claude`` logger only sets a level and propagates to the root
...
LOGGING = {
    ...
    "formatters": {
        "split": {
            "()": "tth_claude.shared.logs.UtcFormatter",
    ...
    "loggers": {"tth_claude": {"level": _LOG_LEVEL}},
}
