...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "tth_claude.settings")

from tth_claude.telemetry import configure_opentelemetry, instrument_django  # noqa: E402
...
from tth_claude.sessions import get_session_store  # noqa: E402
from tth_claude.shared.private_env import seal  # noqa: E402
