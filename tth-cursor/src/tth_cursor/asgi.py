...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "tth_cursor.settings")

from tth_cursor.telemetry import configure_opentelemetry, instrument_django  # noqa: E402
...
from tth_cursor.sessions import get_session_store  # noqa: E402
from tth_cursor.shared.private_env import seal  # noqa: E402
