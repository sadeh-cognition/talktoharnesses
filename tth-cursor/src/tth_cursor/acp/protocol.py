...
from tth_cursor.acp.schemas.cursor_ext import CURSOR_EXTRA_OUTBOUND_METHODS
...
def grok_acp_protocol() -> AcpProtocolConfig:
    ...
    from tth_cursor.acp.schemas.grok_ext import (
...
def cursor_acp_protocol() -> AcpProtocolConfig:
    ...
    return AcpProtocolConfig(
        ...
        request_validators={
            ...
            "cursor/update_todos": is_allowlisted_cursor_update_todos,
        },
    )
