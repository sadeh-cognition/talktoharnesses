"""Create-session and probe orchestration for the Cursor split.
...
from tth_cursor.harness.compatibility import load_cursor_compatibility
...
from tth_cursor.sessions import SessionEntry, get_session_store
from tth_cursor.shared.compatibility import (
    comparable_probe_version,
    compare_cursor_date,
    version_advisory,
)
from tth_cursor.shared.paths import resolve_directory, resolve_kind_executable
from tth_cursor.shared.policy import RuntimePolicy
