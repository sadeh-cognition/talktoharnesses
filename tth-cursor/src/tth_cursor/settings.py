...
# method. The ``tth_cursor`` logger only sets a level and propagates to the root
...
LOGGING = {
    ...
    "formatters": {
        "split": {
            "()": "tth_cursor.shared.logs.UtcFormatter",
    ...
    "loggers": {"tth_cursor": {"level": _LOG_LEVEL}},
}
