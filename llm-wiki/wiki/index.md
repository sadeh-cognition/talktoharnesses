...
- [Project sandbox policies](requirements/project-sandbox-policies.md): egress, credential exchange, read-only readiness, credential mount reconciliation, and tool command checks.
