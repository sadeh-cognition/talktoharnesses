...
from tth_prime_agent.shared.paths import resolve_launch_paths
from tth_prime_agent.shared.policy import RuntimePolicy
from tth_prime_agent.shared.redaction import StreamingTextRedactor
...
class ProcessSupervisor:
    ...
    async def spawn(
        ...
        *,
        ...
        from tth_prime_agent.shared.paths import resolve_directory, resolve_executable
    ...
    async def _cleanup_late_creation(
        ...
        if job is not None and sys.platform == "win32":
            from tth_prime_agent.runtime.windows_job import close_job, terminate_job
    ...
    async def _create_process_windows(
        ...
        from tth_prime_agent.runtime.windows_job import (
