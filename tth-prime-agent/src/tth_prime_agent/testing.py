...
Activate with ``TTH_SPLIT_ADAPTER_FACTORY=tth_prime_agent.testing:echo_adapter_factory``.
...
class SpawnEchoAdapter(EchoAdapter):
    ...
    (point ``TALKTOHARNESSES_PRIME_AGENT_EXECUTABLE`` at a python interpreter).
    """
