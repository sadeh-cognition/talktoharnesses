...
from tth_prime_agent.acp.schemas.base import (
...
from tth_prime_agent.acp.schemas.cursor_ext import CURSOR_EXTRA_OUTBOUND_METHODS
...
def grok_acp_protocol() -> AcpProtocolConfig:
    ...
    from tth_prime_agent.acp.schemas.grok_ext import (
...
def cursor_acp_protocol() -> AcpProtocolConfig:
    ...
    from tth_prime_agent.acp.schemas.cursor_ext import (
