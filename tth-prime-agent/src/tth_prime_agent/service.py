"""Create-session and probe orchestration for the Prime Agent split.

Absorbs the launch responsibilities the proxy's RuntimeManager used to hold
for this kind: probe with timeout, executable resolution, launch snapshot,
preflight, supervised spawn (including the startup bind-retry loop), and
...
from tth_prime_agent.harness.adapter import PrimeAgentAdapter
from tth_prime_agent.harness.compatibility import load_prime_agent_compatibility
from tth_prime_agent.runtime.handle import ProcessHandle
from tth_prime_agent.runtime.spec import ProcessSpec
from tth_prime_agent.runtime.supervisor import ProcessSupervisor
from tth_prime_agent.sessions import SessionEntry, get_session_store
from tth_prime_agent.shared.compatibility import (
    comparable_probe_version,
    compare_dotted,
    version_advisory,
)
from tth_prime_agent.shared.paths import resolve_directory, resolve_kind_executable
from tth_prime_agent.shared.policy import RuntimePolicy
