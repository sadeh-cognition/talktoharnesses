...
from tth_opencode.shared.paths import resolve_launch_paths
...
class ProcessSupervisor:
    ...
    async def spawn(
        ...
        *,
        ...
        from tth_opencode.shared.paths import resolve_directory, resolve_executable
    ...
    async def _cleanup_late_creation(
        ...
        if job is not None and sys.platform == "win32":
            from tth_opencode.runtime.windows_job import close_job, terminate_job
    ...
    async def _create_process_windows(
        ...
        from tth_opencode.runtime.windows_job import (
