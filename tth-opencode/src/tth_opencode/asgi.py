...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "tth_opencode.settings")

from tth_opencode.telemetry import configure_opentelemetry, instrument_django  # noqa: E402
...
from tth_opencode.sessions import get_session_store  # noqa: E402
from tth_opencode.shared.private_env import seal  # noqa: E402
