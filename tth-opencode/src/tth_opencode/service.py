"""Create-session and probe orchestration for the OpenCode split.
...
from tth_opencode.runtime.handle import ProcessHandle
from tth_opencode.runtime.spec import ProcessSpec
from tth_opencode.runtime.supervisor import ProcessSupervisor
from tth_opencode.sessions import SessionEntry, get_session_store
from tth_opencode.shared.compatibility import (
    comparable_probe_version,
    compare_dotted,
    version_advisory,
)
from tth_opencode.shared.paths import resolve_directory, resolve_kind_executable
from tth_opencode.shared.policy import RuntimePolicy
