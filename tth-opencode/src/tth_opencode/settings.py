...
ROOT_URLCONF = "tth_opencode.urls"
...
# method. The ``tth_opencode`` logger only sets a level and propagates to the root
...
LOGGING = {
    ...
    "formatters": {
        "split": {
            "()": "tth_opencode.shared.logs.UtcFormatter",
    ...
    "loggers": {"tth_opencode": {"level": _LOG_LEVEL}},
}
